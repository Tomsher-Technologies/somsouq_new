...
@section('content')
    ...
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <h5 class="mb-0 h6">Update Brand Information</h5>
    </div>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade  show active" id="nav-en" role="tabpanel" aria-labelledby="nav-en-tab">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" placeholder="Enter brand name" value="{{ $brand->getTranslation('name', 'en') }}" name="name_en" class="form-control">
                            ...
                            <div class="tab-pane fade" id="nav-ar" role="tabpanel" aria-labelledby="nav-ar-tab">
                                <div class="form-group mb-3">
                                    <label for="name">Brand Name</label>
                                    <input type="text" placeholder="Enter brand name" value="{{ $brand->getTranslation('name', 'ar') }}" name="name_ar" class="form-control">
                                </div>
                            </div>
                            {{--                        arabic--}}
                            ...
                            <div class="tab-pane fade" id="nav-so" role="tabpanel" aria-labelledby="nav-so-tab">
                                <div class="form-group mb-3">
                                    <label for="name">Brand Name</label>
                                    <input type="text" placeholder="Enter brand name" value="{{ $brand->getTranslation('name', 'so') }}" name="name_so" class="form-control">
                                </div>
                            </div>
                            {{--                        somali--}}
