        ...
        <div class="col-lg-8 mx-auto">
            <div class="card">
                <div class="card-body p-0">
                    ...
                    <form class="p-4" action="{{ route('stone.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade  show active" id="nav-en" role="tabpanel" aria-labelledby="nav-en-tab">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" placeholder="Enter gemstone name" value="{{ old('name_en') }}" name="name_en" class="form-control">
                            ...
                            <div class="tab-pane fade" id="nav-ar" role="tabpanel" aria-labelledby="nav-ar-tab">
                                <div class="form-group mb-3">
                                    <label for="name">Gemstone Name</label>
                                    <input type="text" placeholder="Enter gemstone name" value="{{ old('name_ar') }}" name="name_ar" class="form-control">
                                </div>
                            </div>
                            {{--                        arabic--}}
                            ...
                            <div class="tab-pane fade" id="nav-so" role="tabpanel" aria-labelledby="nav-so-tab">
                                <div class="form-group mb-3">
                                    <label for="name">Gemstone Name</label>
                                    <input type="text" placeholder="Enter gemstone name" value="{{ old('name_so') }}" name="name_so" class="form-control">
                                </div>
                            </div>
                            {{--                        somali--}}
