        ...
        <div class="col-lg-8 mx-auto">
            <div class="card">
                <div class="card-body p-0">
                    ...
                    <form class="p-4" action="{{ route('fashion-type.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="select2 form-control aiz-selectpicker" name="size_variant" data-selected="" data-toggle="select2" data-placeholder="Choose ..." data-live-search="true">
