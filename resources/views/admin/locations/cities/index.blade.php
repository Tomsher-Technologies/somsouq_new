            ...
            <div class="card">
                <form class="" id="sort_cities" action="" method="GET">
                    <div class="card-header row gutters-5">
                        ...
                        <div class="col-md-3">
                            <select class="form-control aiz-selectpicker" data-live-search="true" id="status_city" name="status_city">
                                <option value="">{{ translate('Select Status') }}</option>
                                <option value="1" @if ($status_city == '1') selected @endif>Active</option>
                                <option value="2" @if ($status_city == '2') selected @endif>Inactive</option>
                            </select>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="aiz-pagination">
                        {{ $cities->appends(request()->input())->links('pagination::bootstrap-5') }}
                    </div>
                </div>
            </div>
        </div>
    		...
    		<div class="card">
    			...
    			<div class="card-body">
    				<form action="{{ route('cities.store') }}" method="POST">
    					...
    					<div class="form-group mb-3 text-right mr-2">
