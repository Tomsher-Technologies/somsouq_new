                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade  show active" id="nav-en" role="tabpanel" aria-labelledby="nav-en-tab">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" placeholder="{{ translate('Name') }}" value="{{ $state->getTranslation('name', 'en')}}" name="name_en" class="form-control" required>
                            ...
                            <div class="tab-pane fade" id="nav-ar" role="tabpanel" aria-labelledby="nav-ar-tab">
                                ...
                                <div class="form-group mb-3">
                                    <label for="name">{{ translate('Name') }}</label>
                                    <input type="text" placeholder="{{ translate('Name') }}" value="{{ $state->getTranslation('name', 'ar')}}" name="name_ar" class="form-control">
                                </div>
                            </div>
                            {{--                        arabic--}}
                            ...
                            <div class="tab-pane fade" id="nav-so" role="tabpanel" aria-labelledby="nav-so-tab">
                                ...
                                <div class="form-group mb-3">
                                    <label for="name">{{ translate('Name') }}</label>
                                    <input type="text" placeholder="{{ translate('Name') }}" value="{{ $state->getTranslation('name', 'so')}}" name="name_so" class="form-control">
                                </div>
                            </div>
                            {{--                        somali--}}
                            ...
                            <div class="form-group mb-3 text-right">
                                ...
                                <a href="{{ route('states.index') }}" class="btn btn-sm btn-warning">{{translate('Cancel')}}</a>
                            </div>
