    ...
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-md-right">
                <a href="{{ route('electronic-type.create') }}" class="btn btn-primary">
            ...
            <form class="" id="sort_categories" action="" method="GET" style="width: 100%">
                ...
                <div class="row gutters-5">
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="{{ route('electronic-type.index') }}" class="btn btn-warning">{{translate('Reset')}}</a>
                    </div>
                </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                               href="{{ route('electronic-type.edit', ['electronicType' => $type->id]) }}"
                               title="Edit">
                                <i class="las la-edit"></i>
                            </a>
                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete"
                               data-href="{{ route('electronic-type.destroy', ['electronicType' => $type->id]) }}" title="Delete">
...
@section('script')
    <script type="text/javascript">
        ...
        function update_status(el) {
            ...
            $.post('{{ route('electronic-type.status') }}', {
                _token: '{{ csrf_token() }}',
                id: el.value,
                status: status
            }, function(data) {
