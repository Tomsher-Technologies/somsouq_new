                ...
                <div class="card-body p-0">
                    <ul>
                        ...
                        <li>
                            ...
                            <h5>{{ __('post.watch_type') }}</h5>
                        </li>
                        <li>
                            <h4>{{ getTranslation($postDetail->occasion_name) }}</h4>
                            <h5>{{ __('post.style') }}</h5>
                        </li>
                        <li>
            ...
            <div class="card product-card">
                <div class="card-body p-0">
                    <ul>
                        ...
                        <li><strong>{{ __('post.watch_type') }}:</strong> <span>{{ getTranslation($postDetail->type_name) }}</span></li>
                        ...
                        <li><strong>{{ __('post.style') }}:</strong> <span>{{ getTranslation($postDetail->occasion_name) }}</span></li>
                        <li><strong>{{ __('post.movement') }}:</strong> <span>{{ $postDetail->movement ? ucfirst($postDetail->movement) : "" }}</span></li>
