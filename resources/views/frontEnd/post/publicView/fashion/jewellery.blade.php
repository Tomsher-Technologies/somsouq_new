                ...
                <div class="card-body p-0">
                    <ul>
                        ...
                        <li>
                            ...
                            <h5>{{ __('post.jewellery_type') }}</h5>
                        </li>
                        <li>
                            <h4>{{ getTranslation($postDetail->stone_name) }}</h4>
                            <h5>{{ __('post.gemstone') }}</h5>
                        </li>
                        <li>
                        ...
                        <li>
                            <h4>{{ $postDetail->condition ? ucfirst($postDetail->condition) : "" }}</h4>
            ...
            <div class="card product-card">
                <div class="card-body p-0">
                    <ul>
                        ...
                        <li><strong>{{ __('post.jewellery_type') }}:</strong> <span>{{ getTranslation($postDetail->type_name) }}</span></li>
                        ...
                        <li><strong>{{ __('post.gemstone') }}</strong> <span>{{ getTranslation($postDetail->stone_name) }}</span></li>
