    ...
    <div class="col-md-12">
        ...
        <div class="additional-details">
            <div class="card product-card">
                <div class="card-body p-0">
                    <ul>
                        <li><strong>{{ __('post.brand_name') }}: </strong> <span>{{ getTranslation($postDetail->brand_name) }}</span></li>
                        <li><strong>{{ __('post.clothing_type') }}:</strong> <span>{{ getTranslation($postDetail->type_name) }}</span></li>
