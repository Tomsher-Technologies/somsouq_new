            ...
            <div class="card product-card">
                <div class="card-body p-0">
                    <ul>
                        ...
                        <li><strong>>Carriage Capacity:</strong> <span>{{ $postDetail->carriage_capacity ? $postDetail->carriage_capacity.'Kg' : "" }}</span></li>

                        <li><strong>Number of Tires:</strong> <span>{{ $postDetail->number_of_tire ?? "" }}</span></li>
