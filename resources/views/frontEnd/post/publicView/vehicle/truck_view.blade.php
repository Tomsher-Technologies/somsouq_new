            ...
            <div class="card product-card">
                <div class="card-body p-0">
                    <ul>
                        ...
                        <li><strong>{{ __('post.carriage_capacity') }}: </strong> <span>{{ $postDetail->carriage_capacity ? $postDetail->carriage_capacity.'Kg' : "" }}</span></li>

                        <li><strong>{{ __('post.number_of_tires') }}:</strong> <span>{{ $postDetail->number_of_tire ?? "" }}</span></li>
