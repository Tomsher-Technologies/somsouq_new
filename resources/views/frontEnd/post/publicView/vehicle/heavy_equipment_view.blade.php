    ...
    <div class="col-md-12">
        ...
        <div class="additional-details">
            <div class="card product-card">
                <div class="card-body p-0">
                    <ul>
                        <li><strong>{{ __('post.heavy_equipment_type') }}:</strong> <span>{{ getTranslation($postDetail->heavy_equipment_type_name) }}</span></li>
                        ...
                        <li><strong>{{ __('post.capacity_weight') }}:</strong> <span>{{ $postDetail->carriage_capacity ?? "" }}</span></li>
