    ...
    <div class="col-md-12">
        ...
        <div class="additional-details">
            <div class="card product-card">
                <div class="card-body p-0">
                    <ul>
                        <li><strong>Heavy Equipment Type:</strong> <span>{{ $postDetail->heavy_equipment_type_name ?? "" }}</span></li>
                        ...
                        <li><strong>Capacity/ Weight:</strong> <span>{{ $postDetail->carriage_capacity ?? "" }}</span></li>
