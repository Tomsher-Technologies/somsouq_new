                ...
                <div class="card-body p-0">
                    <ul>
                        @if($sub_category_id == 19)
                            <li><strong>{{ __('post.price_per_day') }}:</strong> <span>{{ $postDetail->price ?? "" }}</span></li>
                            <li><strong>{{ __('post.price_per_month') }}:</strong> <span>{{ $postDetail->price_per_month ?? "" }}</span></li>
                        @endif
                        ...
                        <li><strong>{{ __('post.body_type') }}:</strong> <span>{{ getTranslation($postDetail->body_type_name) }}</span></li>

                        <li><strong>{{ __('post.driver_side') }}:</strong> <span>{{ $postDetail->driver_side ? ucfirst($postDetail->driver_side) : "" }}</span></li>
                        <li><strong>{{ __('post.seats') }}:</strong> <span>{{ $postDetail->seat ?? "" }}</span></li>
