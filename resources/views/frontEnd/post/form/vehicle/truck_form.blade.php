    ...
    <div class="col-md-8 m-auto">
        <div class="post-ad-place" >
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <input type="number" class="form-control" id="formGroupExampleInput" name="carriage_capacity" placeholder="Carriage Capacity (Kg)">
                </div>

                <div class="col-md-6">
                    <input type="number" class="form-control" id="formGroupExampleInput" name="number_of_tire" placeholder="Number of Tires">
                </div>
