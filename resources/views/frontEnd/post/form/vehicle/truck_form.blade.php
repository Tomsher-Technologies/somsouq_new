<div class="post-ad-place" >
    <h4>Tell Us About Your Trucks and Trailers</h4>
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            <input type="number" class="form-control" id="formGroupExampleInput" name="carriage_capacity" placeholder="Carriage Capacity (Kg)" value="{{ $postDetail->carriage_capacity ?? "" }}">
        </div>

        <div class="col-md-6">
            <input type="number" class="form-control" id="formGroupExampleInput" name="number_of_tire" placeholder="Number of Tires" value="{{ $postDetail->number_of_tire ?? "" }}">
        </div>
