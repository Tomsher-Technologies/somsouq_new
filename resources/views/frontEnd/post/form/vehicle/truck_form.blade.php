...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade {{ (App::getLocale() == 'en') ? "show active" : "" }}" id="english" role="tabpanel" aria-labelledby="english-tab">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <select class="form-select {{ isEvent('en') }}" aria-label="Default select example" name="brand_id_en" id="brand_id_en" {{ isDisable('en') }}>
                    ...
                    @foreach($brands as $brand)
                        @if($postDetail)
                            <option value="{{ $brand->id }}" @selected($brand->id == $postDetail->brand_id ?? "")>{{ $brand->getTranslation('name', App::getLocale() ?? 'en') }}</option>
                        @else
            ...
            <div class="col-md-6">
                <input type="number" class="form-control {{ isEvent('en') }}" id="carriage_capacity_en" name="carriage_capacity_en" placeholder="{{ __('post.carriage_capacity') }} (Kg)" value="{{ $postDetail->carriage_capacity ?? "" }}" {{ isDisable('en') }}>
            </div>

            <div class="col-md-6">
                <input type="number" class="form-control {{ isEvent('en') }}" id="number_of_tire_en" name="number_of_tire_en" placeholder="{{ __('post.number_of_tires') }}" value="{{ $postDetail->number_of_tire ?? "" }}" {{ isDisable('en') }}>
            </div>
    ...
    <div class="tab-pane fade {{ (App::getLocale() == 'ar') ? "show active" : "" }}" id="arabic" role="tabpanel" aria-labelledby="arabic-tab">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <input type="number" class="form-control {{ isEvent('ar') }}" id="cylinder_ar" name="cylinder_ar" placeholder="{{ __('post.cylinder_ar') }}" value="{{ $postDetail->cylinder ?? "" }}" {{ isDisable('ar') }}>
            </div>

            <div class="col-md-6">
                <input type="number" class="form-control {{ isEvent('ar') }}" id="carriage_capacity_ar" name="carriage_capacity_ar" placeholder="{{ __('post.carriage_capacity') }} (Kg)" value="{{ $postDetail->carriage_capacity ?? "" }}" {{ isDisable('ar') }}>
            </div>

            <div class="col-md-6">
                <input type="number" class="form-control {{ isEvent('ar') }}" id="number_of_tire_ar" name="number_of_tire_ar" placeholder="{{ __('post.number_of_tires') }}" value="{{ $postDetail->number_of_tire ?? "" }}" {{ isDisable('ar') }}>
            </div>
    ...
    <div class="tab-pane fade {{ (App::getLocale() == 'so') ? "show active" : "" }}" id="somali" role="tabpanel" aria-labelledby="somali-tab">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <input type="number" class="form-control {{ isEvent('so') }}" id="carriage_capacity_so" name="carriage_capacity_so" placeholder="{{ __('post.carriage_capacity') }} (Kg)" value="{{ $postDetail->carriage_capacity ?? "" }}" {{ isDisable('so') }}>
            </div>

            <div class="col-md-6">
                <input type="number" class="form-control {{ isEvent('so') }}" id="number_of_tire_so" name="number_of_tire_so" placeholder="{{ __('post.number_of_tires') }}" value="{{ $postDetail->number_of_tire ?? "" }}" {{ isDisable('so') }}>
            </div>
