...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade {{ (getLocaleLang() == 'so') ? "show active" : "" }}" id="somali" role="tabpanel" aria-labelledby="somali-tab">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('so') }}" id="processor_so" name="processor_so" placeholder="{{ __('post.processor') }}" value="{{ $postDetail->processor ?? "" }}" {{ isDisable('so') }}>
            </div>

            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('so') }}" id="generation_so" name="generation_so" placeholder="{{ __('post.generation') }}" value="{{ $postDetail->generation ?? "" }}" {{ isDisable('so') }}>
            </div>

            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('so') }}" id="ram_so" name="ram_so" placeholder="{{ __('post.ram') }}" value="{{ $postDetail->ram ?? "" }}" {{ isDisable('so') }}>
            </div>

            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('so') }}" id="storage_capacity_so" name="storage_capacity_so" placeholder="{{ __('post.storage_capacity') }}" value="{{ $postDetail->storage_capacity ?? "" }}" {{ isDisable('so') }}>
            </div>

            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('so') }}" id="screen_size_so" name="screen_size_so" placeholder="{{ __('post.screen_size') }}" value="{{ $postDetail->screen_size ?? "" }}" {{ isDisable('so') }}>
            </div>

            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('so') }}" id="graphic_card_so" name="graphic_card_so" placeholder="{{ __('post.graphic_card') }}" value="{{ $postDetail->graphic_card ?? "" }}" {{ isDisable('so') }}>
            </div>

            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('so') }}" id="operating_system_so" name="operating_system_so" placeholder="{{ __('post.operating_system') }}" value="{{ $postDetail->graphic_card ?? "" }}" {{ isDisable('so') }}>
            </div>
    ...
    <div class="tab-pane fade {{ (getLocaleLang() == 'en') ? "show active" : "" }}" id="english" role="tabpanel" aria-labelledby="english-tab">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('en') }}" id="processor_en" name="processor_en" placeholder="{{ __('post.processor') }}" value="{{ $postDetail->processor ?? "" }}" {{ isDisable('en') }}>
            </div>

            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('en') }}" id="generation_en" name="generation_en" placeholder="{{ __('post.generation') }}" value="{{ $postDetail->generation ?? "" }}" {{ isDisable('en') }}>
            </div>

            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('en') }}" id="ram_en" name="ram_en" placeholder="{{ __('post.ram') }}" value="{{ $postDetail->ram ?? "" }}" {{ isDisable('en') }}>
            </div>

            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('en') }}" id="storage_capacity_en" name="storage_capacity_en" placeholder="{{ __('post.storage_capacity') }}" value="{{ $postDetail->storage_capacity ?? "" }}" {{ isDisable('en') }}>
            </div>

            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('en') }}" id="screen_size_en" name="screen_size_en" placeholder="{{ __('post.screen_size') }}" value="{{ $postDetail->screen_size ?? "" }}" {{ isDisable('en') }}>
            </div>

            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('en') }}" id="graphic_card_en" name="graphic_card_en" placeholder="{{ __('post.graphic_card') }}" value="{{ $postDetail->graphic_card ?? "" }}" {{ isDisable('en') }}>
            </div>

            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('en') }}" id="operating_system_en" name="operating_system_en" placeholder="{{ __('post.operating_system') }}" value="{{ $postDetail->graphic_card ?? "" }}" {{ isDisable('en') }}>
            </div>
    ...
    <div class="tab-pane fade {{ (getLocaleLang() == 'ar') ? "show active" : "" }}" id="arabic" role="tabpanel" aria-labelledby="arabic-tab">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('ar') }}" id="processor_ar" name="processor_ar" placeholder="{{ __('post.processor') }}" value="{{ $postDetail->processor ?? "" }}" {{ isDisable('ar') }}>
            </div>

            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('ar') }}" id="generation_ar" name="generation_ar" placeholder="{{ __('post.generation') }}" value="{{ $postDetail->generation ?? "" }}" {{ isDisable('ar') }}>
            </div>

            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('ar') }}" id="ram_ar" name="ram_ar" placeholder="{{ __('post.ram') }}" value="{{ $postDetail->ram ?? "" }}" {{ isDisable('ar') }}>
            </div>

            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('ar') }}" id="storage_capacity_ar" name="storage_capacity_ar" placeholder="{{ __('post.storage_capacity') }}" value="{{ $postDetail->storage_capacity ?? "" }}" {{ isDisable('ar') }}>
            </div>

            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('ar') }}" id="screen_size_ar" name="screen_size_ar" placeholder="{{ __('post.screen_size') }}" value="{{ $postDetail->screen_size ?? "" }}" {{ isDisable('ar') }}>
            </div>

            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('ar') }}" id="graphic_card_ar" name="graphic_card_ar" placeholder="{{ __('post.graphic_card') }}" value="{{ $postDetail->graphic_card ?? "" }}" {{ isDisable('ar') }}>
            </div>

            <div class="col-md-6">
                <input type="text" class="form-control {{ isEvent('ar') }}" id="operating_system_ar" name="operating_system_ar" placeholder="{{ __('post.operating_system') }}" value="{{ $postDetail->graphic_card ?? "" }}" {{ isDisable('ar') }}>
            </div>
