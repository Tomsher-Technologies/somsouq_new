...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade {{ (getLocaleLang() == 'so') ? "show active" : "" }}" id="somali" role="tabpanel" aria-labelledby="somali-tab">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <select class="form-select {{ isEvent('en') }}" aria-label="Default select example" id="display_technology_so" name="display_technology_so" {{ isDisable('so') }}>
                    <option value="">{{ __('post.display_technology') }}</option>
                    @foreach($display as $key => $data)
                        @if($postDetail)
                            <option value="{{ $key }}" @selected($key == $postDetail->display_technology ?? "")>{{ $data }}</option>
                        @else
    ...
    <div class="tab-pane fade {{ (getLocaleLang() == 'en') ? "show active" : "" }}" id="english" role="tabpanel" aria-labelledby="english-tab">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <select class="form-select {{ isEvent('en') }}" aria-label="Default select example" id="display_technology_en" name="display_technology_en" {{ isDisable('en') }}>
                    <option value="">{{ __('post.display_technology') }}</option>
                    @foreach($display as $key => $data)
                        @if($postDetail)
                            <option value="{{ $key }}" @selected($key == $postDetail->display_technology ?? "")>{{ $data }}</option>
    ...
    <div class="tab-pane fade {{ (getLocaleLang() == 'ar') ? "show active" : "" }}" id="arabic" role="tabpanel" aria-labelledby="arabic-tab">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <select class="form-select {{ isEvent('en') }}" aria-label="Default select example" id="display_technology_ar" name="display_technology_ar" {{ isDisable('ar') }}>
                    <option value="">{{ __('post.display_technology') }}</option>
                    @foreach($display as $key => $data)
                        @if($postDetail)
                            <option value="{{ $key }}" @selected($key == $postDetail->display_technology ?? "")>{{ $data }}</option>
