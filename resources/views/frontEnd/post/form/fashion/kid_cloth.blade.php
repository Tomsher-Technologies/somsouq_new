...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade {{ (getLocaleLang() == 'so') ? "show active" : "" }}" id="somali" role="tabpanel" aria-labelledby="somali-tab">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <select class="form-select {{ isEvent('so') }}" aria-label="Default select example" id="type_so" name="type_so" onchange="getTypeWiseSize(this.value, '{{ $postDetail->size_id ?? "" }}')" {{ isDisable('so') }} {{ isRequired('so') }}>
                    <option value="">{{ __('post.clothing_type') }}</option>
    ...
    <div class="tab-pane fade {{ (getLocaleLang() == 'en') ? "show active" : "" }}" id="english" role="tabpanel" aria-labelledby="english-tab">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <select class="form-select {{ isEvent('en') }}" aria-label="Default select example" id="type_en" name="type_en" onchange="getTypeWiseSize(this.value, '{{ $postDetail->size_id ?? "" }}')" {{ isDisable('en') }} {{ isRequired('en') }}>
                    <option value="">{{ __('post.clothing_type') }}</option>
                    @foreach($clothType as $type)
                        @if($postDetail)
    ...
    <div class="tab-pane fade {{ (getLocaleLang() == 'ar') ? "show active" : "" }}" id="arabic" role="tabpanel" aria-labelledby="arabic-tab">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <select class="form-select {{ isEvent('ar') }}" aria-label="Default select example" id="type_ar" name="type_ar" onchange="getTypeWiseSize(this.value, '{{ $postDetail->size_id ?? "" }}')" {{ isDisable('ar') }} {{ isRequired('ar') }}>
                    <option value="">{{ __('post.clothing_type') }}</option>
                    @foreach($clothType as $type)
                        @if($postDetail)
