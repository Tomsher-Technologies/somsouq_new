...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade {{ (getLocaleLang() == 'so') ? "show active" : "" }}" id="somali" role="tabpanel" aria-labelledby="somali-tab">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" id="brand_name_so" name="brand_name_so" placeholder="{{ __('post.brand_name') }}" value="">
            </div>

            <div class="col-md-6">
                <select class="form-select {{ isEvent('so') }}" aria-label="Default select example" id="type_so" name="type_so" onchange="getTypeWiseSize(this.value)" {{ isDisable('so') }} {{ isRequired('so') }}>
            ...
            <div class="col-md-6">
                <select class="form-select {{ isEvent('so') }}" aria-label="Default select example" id="size_so" name="size_so" {{ isDisable('so') }}>
                    <option value="">{{ __('post.size') }}</option>
                </select>
            </div>
            ...
            <div class="col-md-6">
                <select class="form-select {{ isEvent('so') }}" aria-label="Default select example" id="gender_so" name="gender_so" {{ isDisable('so') }}>
                    ...
                    <option value="male">{{ __('post.male') }}</option>
                    <option value="female">{{ __('post.female') }}</option>
                    <option value="unisex">{{ __('post.unisex') }}</option>
                </select>
            </div>
            ...
            <div class="col-md-6">
                <select class="form-select {{ isEvent('so') }}" aria-label="Default select" id="material_so" name="material_so" {{ isDisable('so') }}>
            ...
            <div class="col-md-6">
                <select class="form-select {{ isEvent('so') }}" aria-label="Default select" id="occasion_so" name="occasion_so" {{ isDisable('so') }}>
                    <option value="">{{ __('post.occasion') }}</option>
    ...
    <div class="tab-pane fade {{ (getLocaleLang() == 'en') ? "show active" : "" }}" id="english" role="tabpanel" aria-labelledby="english-tab">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" id="brand_name_en" name="brand_name_en" placeholder="{{ __('post.brand_name') }}" value="">
            </div>

            <div class="col-md-6">
                <select class="form-select {{ isEvent('en') }}" aria-label="Default select example" id="type_en" name="type_en" onchange="getTypeWiseSize(this.value)" {{ isDisable('en') }} {{ isRequired('en') }}>
                    <option value="">{{ __('post.type') }}</option>
                    @foreach($shoesType as $type)
            ...
            <div class="col-md-6">
                <select class="form-select {{ isEvent('en') }}" aria-label="Default select example" id="size_en" name="size_en" {{ isDisable('en') }}>
                    <option value="">{{ __('post.size') }}</option>
                </select>
            </div>
            ...
            <div class="col-md-6">
                <select class="form-select {{ isEvent('en') }}" aria-label="Default select" id="material_en" name="material_en" {{ isDisable('en') }}>
                    <option value="">{{ __('post.material') }}</option>
                    @foreach($materials as $material)
    ...
    <div class="tab-pane fade {{ (getLocaleLang() == 'ar') ? "show active" : "" }}" id="arabic" role="tabpanel" aria-labelledby="arabic-tab">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" id="brand_name_ar" name="brand_name_ar" placeholder="{{ __('post.brand_name') }}" value="">
            </div>

            <div class="col-md-6">
                <select class="form-select {{ isEvent('ar') }}" aria-label="Default select example" id="type_ar" name="type_ar" onchange="getTypeWiseSize(this.value)" {{ isDisable('ar') }} {{ isRequired('ar') }}>
                    <option value="">{{ __('post.type') }}</option>
                    @foreach($shoesType as $type)
            ...
            <div class="col-md-6">
                <select class="form-select {{ isEvent('ar') }}" aria-label="Default select example" id="size_ar" name="size_ar" {{ isDisable('ar') }}>
                    <option value="">{{ __('post.size') }}</option>
                </select>
            </div>
            ...
            <div class="col-md-6">
                <select class="form-select {{ isEvent('ar') }}" aria-label="Default select" id="material_ar" name="material_ar" {{ isDisable('ar') }}>
                    <option value="">{{ __('post.material') }}</option>
                    @foreach($materials as $material)
