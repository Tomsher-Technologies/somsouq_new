...
<div class="tab-content" id="myTabContent">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <select class="form-select {{ isEvent('so') }}" aria-label="Default select example" id="type_so" name="type_so" {{ isDisable('so') }} {{ isRequired('so') }}>
                    <option value="">{{ __('post.jewellery_type') }}</option>
                    @foreach($jewelleryType as $type)
                        @if($postDetail)
            ...
            <div class="col-md-6">
                <select class="form-select {{ isEvent('so') }}" aria-label="Default select example" id="gemstone_so" name="gemstone_so" {{ isDisable('so') }}>
                    <option value="">{{ __('post.gemstone') }}</option>
                    @foreach($gemstones as $stone)
                        @if($postDetail)
                            <option value="{{ $stone->id }}" @selected($stone->id == $postDetail->gemstone_id ?? "")>{{ $stone->getTranslation('name', 'so') }}</option>
                        @else
                            <option value="{{ $stone->id }}">{{ $stone->getTranslation('name', 'so') }}</option>
                        @endif
                    @endforeach
                </select>
            </div>
    ...
    <div class="tab-pane fade {{ (getLocaleLang() == 'en') ? "show active" : "" }}" id="english" role="tabpanel" aria-labelledby="english-tab">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <select class="form-select {{ isEvent('en') }}" aria-label="Default select example" id="gemstone_en" name="gemstone_en" {{ isDisable('en') }}>
                    <option value="">{{ __('post.gemstone') }}</option>
                    @foreach($gemstones as $stone)
                        @if($postDetail)
                            <option value="{{ $stone->id }}" @selected($stone->id == $postDetail->gemstone_id ?? "")>{{ $stone->getTranslation('name', 'en') }}</option>
                        @else
                            <option value="{{ $stone->id }}">{{ $stone->getTranslation('name', 'en') }}</option>
                        @endif
                    @endforeach
                </select>
            </div>
    ...
    <div class="tab-pane fade {{ (getLocaleLang() == 'ar') ? "show active" : "" }}" id="arabic" role="tabpanel" aria-labelledby="arabic-tab">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <select class="form-select {{ isEvent('ar') }}" aria-label="Default select example" id="gemstone_ar" name="gemstone_ar" {{ isDisable('ar') }}>
                    <option value="">{{ __('post.gemstone') }}</option>
                    @foreach($gemstones as $stone)
                        @if($postDetail)
                            <option value="{{ $stone->id }}" @selected($stone->id == $postDetail->gemstone_id ?? "")>{{ $stone->getTranslation('name', 'ar') }}</option>
                        @else
                            <option value="{{ $stone->id }}">{{ $stone->getTranslation('name', 'ar') }}</option>
                        @endif
                    @endforeach
                </select>
            </div>
