<div class="ad-detail-spec">
    ...
    <ul>
        ...
        <li><span>Carriage Capacity</span> <span>{{ $postDetail->carriage_capacity ? $postDetail->carriage_capacity.'Kg' : "" }} </li>
    </ul>

    <ul>
        <li><span>Number of Tires</span> <span>{{ $postDetail->number_of_tire ?? "" }} </li>
